...
<body  style="background:url(images/bg3.png)">
			...
			<div class="container-fluid">
					<div class="row" style="margin:1% 0 1% 0;background:url(images/ui.pn);font-family:geogia"> 
				...
				<div class="row" style="margin:2% 0 2% 0;background:url(images/ui.png);margin-top:-5%"> 
						<div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2" style="padding:1%;margin-top:-2%">	
							<div class="jumbotron">
						<h4 style="text-align:center">Enter your Email to Print your Registration Form</h4>
							<form role="form" method="POST" action="RegDetail.php" >
